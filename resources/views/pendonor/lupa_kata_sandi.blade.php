...
<section class="login-block fill-height">
  ...
  <div class="col-md-4 login-sec">
    ...
    <div class="show-login" style="margin-top: -35px">
      ...
      <h3 style="color: #b61322; margin-top: 10px" class="text-center">Ulang Kata Sandi</h3>
      ...
      <form id="msform" style="margin-top: -10px;" action="{{ url('pendonor/auth/send_email') }}" method="post">
        @csrf

        <input type="text" name="username" placeholder="Masukkan kode pendonor / username anda" required/>
 ...
 {{--          <label class="form-check-label">
        ...
        {{-- <a href="{{route('pendonor.kegiatan')}}" class="action-button" >Login</a> --}}
          ...
          <button type="submit" class="btn btn-danger btn-lg btn-block">Reset password</button>
