...
<nav class="navbar2 navbar-light bg-light">
  <div class="row">
    <div class="col-md-4">
          <a class="navbar-brand" style="color:rgba(144, 28, 44, 0.9); font-weight: bold" href="#">
...
<section class="login-block fill-height">
  ...
  <div class="col-md-4 login-sec">
    ...
    <div class="show-login" style="margin-top: -35px">
      ...
      <h3 style="color: #b61322; margin-top: 10px" class="text-center">Kata Sandi Baru</h3>
      ...
      @if (!empty(Session::get('ses_username')))
        <div class="alert alert-info">
           - Kode pendonor / Username: <b>{{ session('ses_username') }}</b>
        </div>
      @else
      <div class="alert alert-info">
           - Dapatkan kode dari email <a href="{{ url('pendonor/auth/lupa_sandi') }}">disini</a>
        </div>
      ...
      <form id="msform" style="margin-top: -10px;" action="{{ url('pendonor/auth/konfirmasi_lupa_sandi') }}" method="post">
        @csrf
        {{-- {{ dd($data->Kode) }} --}}
        <input type="hidden" placeholder="email" value="{{ Session::get('ses_email') }}" name="email" required="" />
        <input type="hidden" placeholder="Kode pendonor/username" value="{{ Session::get('ses_username') }}" name="user_username" required="" />
        <input type="password" name="user_password" placeholder="Password baru" required="" />

        <input type="text" name="user_kode_forget_password" placeholder="Masukan Kode dari email" required="" />
        {{-- <input type="password" name="penerima" placeholder="Ulangi password" required="" /> --}}
