...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('mitra/dashboard')}}">
      <div class="sidebar-brand-icon">
        <img class="logo-dashboard" src="{{asset('assets_admin/img/icon/logo_rs_red.png')}}">
      </div>
      <div class="sidebar-brand-text mx-3">SIDONI RS<sup></sup></div>
    </a>
    ...
    <li class="nav-item {{ request()->is('mitra/dashboard') ? 'active' : '' }}">
      <a class="nav-link" href="{{ url('mitra/dashboard')}}">
